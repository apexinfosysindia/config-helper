 ...
 * Source: https://github.com/apexos/core/blob/dev/apexos/helpers/config_validation.py
 */
import {
  Area,
  Data,
...
export interface DelayAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#delay
   */
...
export interface EventAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#fire-an-event
   */
  event: string;
...
export interface IfAction {
  ...
  /**
   * This action allows you to select a sequence of other actions from a list of sequences.
   * https://docs.apexinfosys.in/docs/scripts/#if-then
   */
...
export interface ParallelAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#parallelizing-actions
   */
...
export interface RepeatAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#repeat-a-group-of-actions
   */
  repeat: {
    /**
     ...
     * https://docs.apexinfosys.in/docs/scripts/#counted-repeat
     */
     ...
     * https://docs.apexinfosys.in/docs/scripts/#for-each
     */
    for_each?: Data[] | Template | Template[];

    /**
     * The sequence of actions to be repeatedly performed in the script.
     * https://docs.apexinfosys.in/integrations/script/#sequence
     */
    sequence: Action | Action[] | IncludeList;
     ...
     * https://docs.apexinfosys.in/docs/scripts/#repeat-until
     */
     ...
     * https://docs.apexinfosys.in/docs/scripts/#while-loop
     */
...
export interface SceneAction {
  ...
  /**
   * Activate a scene.
   * https://docs.apexinfosys.in/docs/scripts/#activate-a-scene
   */
  scene: SceneEntity;
...
export interface SequenceAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#grouping-actions
   */
  sequence: Action | Action[] | IncludeList;
}
...
export interface ServiceAction {
  /**
   * Service call alias.
   * https://docs.apexinfosys.in/docs/scripts/service-calls/
   */
  alias?: string;
   ...
   * https://docs.apexinfosys.in/docs/scripts/service-calls/#use-templates-to-decide-which-service-to-call
   */
   ...
   * https://docs.apexinfosys.in/docs/scripts/service-calls/#passing-data-to-the-service-call
   */
  data?: Data | Template;

  /**
   * You can use templates directly in the data parameter, replace "data_template" with just "data".
   * https://docs.apexinfosys.in/docs/scripts/service-calls/#use-templates-to-determine-the-attributes
   */
   ...
   * https://docs.apexinfosys.in/docs/scripts/service-calls/#use-templates-to-handle-response-data
   */
...
export interface StopAction {
  /**
   * Stop call alias.
   * https://docs.apexinfosys.in/docs/scripts/#stopping-a-script-sequence
   */
  alias?: string;
...
export interface WaitForTriggerAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#wait-for-trigger
   */
...
export interface WaitTemplateAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#wait
   */
...
export interface VariablesAction {
   ...
   * https://docs.apexinfosys.in/docs/scripts/#variables
   */
  variables: Data;
}
