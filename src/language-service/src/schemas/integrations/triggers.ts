...
interface CalendarTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#calendar-trigger
   */
  trigger?: "calendar";
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#disabling-a-trigger
   */
  enabled?: boolean;
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger#trigger-variables
   */
  variables?: Data;
}
...
interface ConversationTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#sentence-trigger
   */
...
interface DeviceTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#device-triggers
   */
  trigger?: "device";
...
interface EventTrigger {
  ...
  /**
   * Fires when an event is being received. Events are the raw building blocks of ApexOS. You can match events on just the event name or also require specific event data to be present.
   * https://docs.apexinfosys.in/docs/automation/trigger/#event-trigger
   */
  trigger?: "event";
...
interface GeolocationTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#geolocation-trigger
   */
...
interface ApexOSTrigger {
  /**
   * Alias for the ApexOS trigger.
   */
  alias?: string;

  /**
   * This trigger fires when ApexOS has started up or going to shut down.
   * https://docs.apexinfosys.in/docs/automation/trigger/#apexos-trigger
   */
  trigger?: "apexos";

  /**
   * Legacy syntax, use "trigger: apexos" instead.
   */
  platform?: LegacySyntax;
  ...
  /**
   * Specified the event to listen to: Either the ApexOS start or shutdown event.
   * https://docs.apexinfosys.in/docs/automation/trigger/#apexos-trigger
   */
...
interface MqttTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#mqtt-trigger
   */
  trigger?: "mqtt";
...
interface NumericStateTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#numeric-state-trigger
   */
...
interface PersistentNotificationTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#persistent-notification-trigger
   */
...
interface StateTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#state-trigger
   */
  trigger?: "state";
...
interface SunTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#sun-trigger
   */
  trigger?: "sun";
...
interface TemplateTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#template-trigger
   */
  trigger?: "template";
...
interface TimeTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#time-trigger
   */
  trigger?: "time";
...
interface TimePatternTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#time-pattern-trigger
   */
...
interface WebhookTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#webhook-trigger
   */
  trigger?: "webhook";
...
interface ZoneTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#zone-trigger
   */
  trigger?: "zone";
...
interface TagTrigger {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger#tag-trigger
   */
  trigger?: "tag";
