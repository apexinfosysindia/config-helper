/**
 * Group integration
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/automation/__init__.py
 */
...
interface BaseItem {
   ...
   * https://docs.apexinfosys.in/integrations/script/#alias
   */
  alias?: string;
   ...
   * https://docs.apexinfosys.in/integrations/script/#description
   */
  description?: string;
   ...
   * https://docs.apexinfosys.in/integrations/script/#passing-variables-to-scripts
   */
  fields?: {
    [key: string]: Field;
  };
   ...
   * https://docs.apexinfosys.in/integrations/script/#script-modes
   */
  mode?: Mode;
   ...
   * https://docs.apexinfosys.in/docs/automation/troubleshooting
   */
  trace?: {
    /**
   ...
   * https://docs.apexinfosys.in/integrations/script/#variables
   */
  variables?: Data;
}
...
interface Field {
   ...
   * https://docs.apexinfosys.in/integrations/script/#advanced
   */
  advanced?: boolean;

  /**
   * The default value of this parameter field.
   * https://docs.apexinfosys.in/integrations/script/#default
   */
  default?: any;
   ...
   * https://docs.apexinfosys.in/integrations/script/#example
   */
  example?: string;

  /**
   * The name of the script parameter field.
   * https://docs.apexinfosys.in/integrations/script/#name
   */
  name?: string;
   ...
   * https://docs.apexinfosys.in/integrations/script/#selector
   */
  selector?: Selector;
}
...
interface BlueprintItem extends BaseItem {
   ...
   * https://docs.apexinfosys.in/docs/blueprint/tutorial/#using-your-blueprint-via-configurationyaml
   */
