...
interface BaseItem {
   ...
   * In case automations need to be always enabled or disabled when ApexOS starts, then you can set the initial_state in your automations. Otherwise, the previous state will be restored.
   * https://docs.apexinfosys.in/docs/automation/yaml/#initial_state
   */
   ...
   * https://docs.apexinfosys.in/docs/automation/modes/
   *
   * @minimum 2
   */
  max?: number;
  ...
  trace?: {
     ...
     * https://docs.apexinfosys.in/docs/automation/yaml/#number-of-debug-traces-stored
     */
   ...
   * https://docs.apexinfosys.in/docs/automation/basics/
   */
  variables?: Data;
