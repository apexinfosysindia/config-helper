/**
 * Group integration
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/group/__init__.py
 */
import { 
...
interface Item {
   ...
   * https://docs.apexinfosys.in/integrations/group#entities
   */
  entities: Entities;

  /**
   * The icon that shows in the frontend.
   * https://docs.apexinfosys.in/integrations/group#icon
   */
  icon?: string;

  /**
   * Name of the group.
   * https://docs.apexinfosys.in/integrations/group#name
   */
  name?: string;
}
...
export interface BinarySensorPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/binary_sensor.group
   */
  platform: "group";

  /**
   * Set this to true if the group state should only turn on if all grouped entities are on, false otherwise.
   * https://docs.apexinfosys.in/integrations/binary_sensor.group/#all
   */
  all?: boolean;

  /**
   * Sets the class of the device, changing the device state and icon that is displayed on the UI.
   * https://docs.apexinfosys.in/integrations/binary_sensor.group#device_class
   */
  device_class?: DeviceClassesBinarySensor;

  /**
   * A list of entities to be included in the binary sensor group.
   * https://docs.apexinfosys.in/integrations/binary_sensor.group/#entities
   */
  entities: Entities;

  /**
   * The name of the binary sensor group. Defaults to "Binary Sensor Group".
   * https://docs.apexinfosys.in/integrations/binary_sensor.group#name
   */
  name?: string;

  /**
   * An ID that uniquely identifies this binary sensor group. If two binary sensors have the same unique ID, ApexOS will raise an error.
   * https://docs.apexinfosys.in/integrations/binary_sensor.group#unique_id
   */
  unique_id?: string;
}
...
export interface ButtonPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#button-groups
   */
  platform: "group";
...
export interface CoverPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#cover-groups
   */
  platform: "group";
...
export interface EventPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#event-groups
   */
  platform: "group";
...
export interface FanPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#fan-groups
   */
  platform: "group";
...
export interface LightPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/light.group/
   */
  platform: "group";

  /**
   * Set this to true if the group state should only turn on if all grouped entities are on, false otherwise.
   * https://docs.apexinfosys.in/integrations/light.group/#all
   */
  all?: boolean;

  /**
   * A list of entities to be included in the light group.
   * https://docs.apexinfosys.in/integrations/light.group/#entities
   */
  entities: Entities;

  /**
   * The name of the light group. Defaults to "Light Group".
   * https://docs.apexinfosys.in/integrations/light.group/#name
   */
  name?: string;

  /**
   * An ID that uniquely identifies this light group. If two lights have the same unique ID, ApexOS will raise an error.
   * https://docs.apexinfosys.in/integrations/light.group/#unique_id
   */
  unique_id?: string;
}
...
export interface LockPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#lock-groups
   */
  platform: "group";
...
export interface MediaPlayerPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#media-player-groups
   */
  platform: "group";
...
export interface SensorPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#sensor-number-and-input_number-groups
   */
  platform: "group";

  /**
   * Sets the class of the device, changing the device state and icon that is displayed on the UI.
   * https://docs.apexinfosys.in/integrations/group#device_class
   */
   ...
   * https://docs.apexinfosys.in/integrations/group#ignore_non_numeric
   */
   ...
   * https://docs.apexinfosys.in/integrations/group#state_class
   */
  state_class?: StateClassesSensor;

  /**
   * The type of sensor: min, max, last, mean, median, range, product, stdev, or sum.
   * https://docs.apexinfosys.in/integrations/group#type
   */
   ...
   * https://docs.apexinfosys.in/integrations/group#unit_of_measurement
   */
...
export interface SwitchPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#binary-sensor-light-and-switch-groups
   */
  platform: "group";
...
export interface NotifyPlatformSchema extends PlatformSchema {
   ...
   * https://docs.apexinfosys.in/integrations/group#notify-groups
   */
  platform: "group";
...
interface NotifyService {
   ...
   * https://docs.apexinfosys.in/integrations/group#action
   */
  action: string;

  /**
   * A dictionary containing parameters to add to all notify payloads.
   * https://docs.apexinfosys.in/integrations/group#data
   */
  data?: Data;
}
