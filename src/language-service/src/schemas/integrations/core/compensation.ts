 ...
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/compensation/__init__.py
 */
...
interface Item {
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#source
   */
  source: Entity;
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#data_points
   */
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#unique_id
   */
  unique_id?: string;
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#attribute
   */
  attribute?: string;
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#degree
   */
  degree?: PositiveInteger;

  /**
   * Defines the precision of the calculated values, through the argument of round().
   * https://docs.apexinfosys.in/integrations/compensation/#precision
   */
  precision?: PositiveInteger;

  /**
   * Defines the units of measurement of the sensor, if any.
   * https://docs.apexinfosys.in/integrations/compensation/#unit_of_measurement
   */
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#lower_limit
   */
  lower_limit?: boolean;
   ...
   * https://docs.apexinfosys.in/integrations/compensation/#upper_limit
   */
  upper_limit?: boolean;
}
