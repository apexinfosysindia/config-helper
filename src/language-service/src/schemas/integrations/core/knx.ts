/**
 * KNX integration
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/knx/__init__.py
 */
import {
  Data,
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/integrations/knx#binary-sensor
   */
  binary_sensor?: BinarySensor[];

  /**
   * The KNX binary sensor platform allows you to monitor KNX binary sensors.
   * https://docs.apexinfosys.in/integrations/knx/#button
   */
  button?: Button[];
   ...
   * https://docs.apexinfosys.in/integrations/knx#cover
   */
  cover?: Cover[];

  /**
   * The KNX date platform allows to send date values to the KNX bus and update its state from received telegrams.
   * https://docs.apexinfosys.in/integrations/knx#date
   */
  date?: DateEntity[];

  /**
   * The KNX datetime platform allows to send datetime values to the KNX bus and update its state from received telegrams.
   * https://docs.apexinfosys.in/integrations/knx#datetime
   */
  datetime?: DateTimeEntity[];

  /**
   * Defines lists of patterns for filtering KNX group addresses. Telegrams with destination addresses matching this pattern are sent to the ApexOS event bus as knx_event.
   * https://docs.apexinfosys.in/integrations/knx/#events
   */
  event?: Event[];

  /**
   * KNX integration is able to expose entity states or attributes to KNX bus.
   * https://docs.apexinfosys.in/integrations/knx#exposing-entity-states-entity-attributes-or-time-to-knx-bus
   */
  expose?: (ExposeTime | ExposeSensor)[];

  /**
   * The KNX fan integration is used to control KNX fans.
   * https://docs.apexinfosys.in/integrations/knx#fan
   */
  fan?: Fan[];

  /**
   * The KNX light integration is used as an interface to control KNX actuators for lighting applications.
   * https://docs.apexinfosys.in/integrations/knx#light
   */
  light?: Light[];

  /**
   * The KNX notify platform allows you to send notifications to KNX devices as DPT16 strings.
   * https://docs.apexinfosys.in/integrations/knx#notify
   */
  notify?: Notify[];
   ...
   * https://docs.apexinfosys.in/integrations/knx#number
   */
  number?: NumberEntity[];

  /**
   * The KNX scenes platform allows you to trigger KNX scenes.
   * https://docs.apexinfosys.in/integrations/knx#scene
   */
  scene?: Scene[];
...
interface BinarySensor {
   ...
   * https://docs.apexinfosys.in/integrations/knx#context_timeout
   *
   * @minimum 1
   * @maximum 100
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#device_class
   */
  device_class?: DeviceClassesBinarySensor;

  /**
   * Specifies if telegrams should ignore the internal state and always trigger a ApexOS state update.
   * https://docs.apexinfosys.in/integrations/knx#ignore_internal_state
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#invert
   */
  invert?: boolean;

  /**
   * A name for this device used within ApexOS.
   * https://docs.apexinfosys.in/integrations/knx#name
   */
  name?: string;

  /**
   * Reset back to “off” state after specified seconds.
   * https://docs.apexinfosys.in/integrations/knx#reset_after
   */
  reset_after?: number;

  /**
   * KNX group address of the binary sensor.
   * https://docs.apexinfosys.in/integrations/knx#state_address
   */
  state_address: GroupAddresses;

  /**
   * Actively read the value from the bus.
   * https://docs.apexinfosys.in/integrations/knx#sync_state
   */
...
interface Button {
   ...
   * https://docs.apexinfosys.in/integrations/knx#address
   */
  address: GroupAddress;

  /**
   * The category of the entity.
   * https://docs.apexinfosys.in/integrations/knx#entity_category
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#payload
   */
  payload?: Integer;
   ...
   * https://docs.apexinfosys.in/integrations/knx#payload_length
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx/#value-types
   */
  type?: ValueType;
}
...
interface Climate {
   ...
   * https://docs.apexinfosys.in/integrations/knx#active_state_addres
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#controller_status_address
   */
  controller_status_address?: GroupAddresses;

  /**
   * KNX address for reading HVAC controller status.
   * https://docs.apexinfosys.in/integrations/knx#controller_status_state_address
   */
  controller_status_state_address?: GroupAddresses;

  /**
   * Overrides the default controller mode. Any ApexOS hvac_mode can be configured. This can, for example, be set to “cool” for cooling-only devices.
   * https://docs.apexinfosys.in/integrations/knx#climate
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#fan_max_step
   */
  fan_max_step?: number;

  /**
   * KNX group address for setting the percentage or step of the fan. DPT 5.001 or DPT 5.010
   * https://docs.apexinfosys.in/integrations/knx#fan_speed_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#fan_speed_state_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#heat_cool_address
   */
  heat_cool_address?: GroupAddresses;

  /**
   * KNX address for reading heat/cool mode. DPT 1.100
   * https://docs.apexinfosys.in/integrations/knx#heat_cool_state_address
   */
  heat_cool_state_address?: GroupAddresses;

  /**
   * KKNX address for reading current humidity. DPT 9.007
   * https://docs.apexinfosys.in/integrations/knx#humidity_state_address
   */
  humidity_state_address?: GroupAddresses;

  /**
   * Override the minimum temperature.
   * https://docs.apexinfosys.in/integrations/knx#max_temp
   */
  max_temp?: number;

  /**
   * Override the minimum temperature.
   * https://docs.apexinfosys.in/integrations/knx#min_temp
   */
  min_temp?: number;
   ...
   * https://docs.apexinfosys.in/integrations/knx#setpoint_shift_address
   */
  setpoint_shift_address?: GroupAddresses;

  /**
   * Maximum value of setpoint shift.
   * https://docs.apexinfosys.in/integrations/knx#setpoint_shift_max
   *
   * @TJS-type integer
   * @minimum 0
   * @maximum 32
   ...
   * https://docs.apexinfosys.in/integrations/knx#setpoint_shift_min
   *
   * @TJS-type integer
   * @minimum -32
   * @maximum 0
   ...
   * https://docs.apexinfosys.in/integrations/knx#setpoint_shift_mode
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#temperature_address
   */
  temperature_address: GroupAddresses;

  /**
   * Defines the step size in Kelvin for each step of setpoint_shift.
   * https://docs.apexinfosys.in/integrations/knx#temperature_step
   *
   * @minimum 0
   * @maximum 2
   */
...
interface Cover {
   ...
   * https://docs.apexinfosys.in/integrations/knx#angle_address
   */
  angle_address?: GroupAddresses;

  /**
   * Separate KNX group address for requesting the current tilt angle of the cover. DPT 5.001
   * https://docs.apexinfosys.in/integrations/knx#angle_state_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#travelling_time_down
   *
   * @minimum 0
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#travelling_time_up
   *
   * @minimum 0
   */
...
interface ExposeSensor {
   ...
   * https://docs.apexinfosys.in/integrations/knx#respond_to_read
   */
...
interface Fan {
   ...
   * https://docs.apexinfosys.in/integrations/knx#max_step
   *
   * @TJS-type integer
   * @minimum 0
   * @maximum 255
   ...
   * https://docs.apexinfosys.in/integrations/knx#oscillation_address
   */
  oscillation_address?: GroupAddresses;

  /**
   * KNX group address for retrieving the state of the fan oscillation. DPT 1
   * https://docs.apexinfosys.in/integrations/knx#oscillation_stat_address
   */
...
interface LightColor {
   ...
   * https://docs.apexinfosys.in/integrations/knx#brightness_address
   */
  brightness_address: GroupAddresses;

  /**
   * KNX group address for the current brightness of this color component. DPT 5.001
   * https://docs.apexinfosys.in/integrations/knx#brightness_state_address
   */
...
interface Light {
   ...
   * https://docs.apexinfosys.in/integrations/knx#color_address
   */
  color_address?: GroupAddresses;

  /**
   * KNX group address for retrieving the RGB color of the light. DPT 232.600
   * https://docs.apexinfosys.in/integrations/knx#color_state_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#color_temperature_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#color_temperature_mode
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#color_temperature_state_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#hue_address
   */
  hue_address?: GroupAddresses;

  /**
   * KNX group address for retrieving the hue of the light color in degrees. DPT 5.003
   * https://docs.apexinfosys.in/integrations/knx#hue_state_address
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#individual_colors
   */
  individual_colors?: {
    /**
     * Group addresses for the blue component.
     * https://docs.apexinfosys.in/integrations/knx#blue
     */
    blue: LightColor;

    /**
     * Group addresses for the green component.
     * https://docs.apexinfosys.in/integrations/knx#green
     */
    green: LightColor;

    /**
     * Group addresses for the red component.
     * https://docs.apexinfosys.in/integrations/knx#red
     */
    red: LightColor;

    /**
     * Group addresses for the white component.
     * https://docs.apexinfosys.in/integrations/knx#white
     */
    white?: Light;
  };
   ...
   * https://docs.apexinfosys.in/integrations/knx#max_kelvin
   *
   * @TJS-type integer
   * @minimum 1
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#min_kelvin
   *
   * @TJS-type integer
   * @minimum 1
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#xyy_address
   */
  xyy_address?: GroupAddresses;

  /**
   * KNX group address for retrieving the xyY color of the light. DPT 242.600
   * https://docs.apexinfosys.in/integrations/knx#xyy_state_address
   */
...
interface Notify {
   ...
   * https://docs.apexinfosys.in/integrations/knx#type
   */
  type?: "string" | "latin_1";
}
...
interface Scene {
   ...
   * https://docs.apexinfosys.in/integrations/knx#scene_number
   *
   * @TJS-type integer
   * @minimum 1
   * @maximum 64
...
interface Select {
   ...
   * https://docs.apexinfosys.in/integrations/knx#options
   */
  options: {
    /**
     * The name of the option used to trigger the assigned `payload`.
     * https://docs.apexinfosys.in/integrations/knx#option
     */
    option: string;
...
interface Sensor {
  /**
   * Defines if telegrams with equal payload as the previously received telegram should trigger a state update within ApexOS.
   * https://docs.apexinfosys.in/integrations/knx#always_callback
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#state_class
   */
...
interface Weather {
   ...
   * https://docs.apexinfosys.in/integrations/knx#address_air_pressure
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#address_brightness_east
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#address_brightness_north
   */
   ...
   * https://docs.apexinfosys.in/integrations/knx#address_brightness_south
   */
...
export interface KnxTelegramTrigger {
   ...
   * https://docs.apexinfosys.in/integrations/knx/#triggers
   */
