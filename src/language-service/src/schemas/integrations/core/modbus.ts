/**
 * Modbus integration
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/modbus/
 * Documentation: https://docs.apexinfosys.in/integrations/modbus/
 */
import {
...
interface Item {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#name
   */
  name: string;

  /**
   * Type of modbus.
   * https://docs.apexinfosys.in/integrations/modbus/#type
   */
...
interface BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#name-1
   */
  name: string;

  /**
   * Address of coil/register. Note that this can also be specified in Hex. For example: 0x789A
   * https://docs.apexinfosys.in/integrations/modbus/#address
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#scan_interval
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#device_address
   */
  device_address?: Integer;

  /**
   * Identical to device_address.
   * https://docs.apexinfosys.in/integrations/modbus/#slave
   */
  slave?: Integer;

  /**
   * ID that uniquely identifies this entity. Slaves will be given a unique_id of <<unique_id>>_<<slave_index>>. If two entities have the same unique ID, ApexOS will raise an exception.
   * https://docs.apexinfosys.in/integrations/modbus/#unique_id
   */
  unique_id?: string;
}
...
interface BinarySensorItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#device_class
   */
  device_class?: DeviceClassesBinarySensor;

  /**
   * Type of request discrete_input, coil, holding or input.
   * https://docs.apexinfosys.in/integrations/modbus/#input_type
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#virtual_count
   */
  virtual_count?: Integer;

  /**
   * Identical to virtual_count.
   * https://docs.apexinfosys.in/integrations/modbus/#slave_count
   */
  slave_count?: Integer;
}
...
interface ClimateItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#temperature_unit
   */
  temperature_unit?: "C" | "F";

  /**
   * Number of valid decimals for temperature.
   * https://docs.apexinfosys.in/integrations/modbus/#precision
   */
  precision?: Integer;

  /**
   * Step size target temperature.
   * https://docs.apexinfosys.in/integrations/modbus/#temp_step
   */
  temp_step?: number;

  /**
   * Maximum setpoint for target temperature.
   * https://docs.apexinfosys.in/integrations/modbus/#max_temp
   */
  max_temp?: Integer;

  /**
   * Minimum setpoint for target temperature.
   * https://docs.apexinfosys.in/integrations/modbus/#min_temp
   */
  min_temp?: Integer;
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#count
   */
  count?: Integer;

  /**
   * Response representation when reading the current temperature register(s).
   * https://docs.apexinfosys.in/integrations/modbus/#data_type
   */
  data_type?:
    | "custom"
    | "float16"
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#input_type-1
   */
  input_type?: "holding" | "input";

  /**
   * Final offset for current temperature (output = scale * value + offset).
   * https://docs.apexinfosys.in/integrations/modbus/#offset
   */
  offset?: number;
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#target_temp_register
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#target_temp_write_registers
   */
  target_temp_write_registers?: boolean;

  /**
   * Scale factor (output = scale * value + offset) for setting target temperature.
   * https://docs.apexinfosys.in/integrations/modbus/#scale
   */
  scale?: number;
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#hvac_mode_register
   */
  hvac_mode_register?: {
    /**
     * Address of HVAC mode register.
     * https://docs.apexinfosys.in/integrations/modbus/#address-2
     */
    address: Integer;
     ...
     * https://docs.apexinfosys.in/integrations/modbus/#write_registers
     */
    write_registers?: boolean;

    /**
     * Mapping between the register values and HVAC modes.
     * https://docs.apexinfosys.in/integrations/modbus/#values-1
     */
    values: {
      /**
       ...
       * https://docs.apexinfosys.in/integrations/modbus/#state_off
       */
      state_off?: Integer | Integer[];

      /**
       * Value corresponding to HVAC Heat mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_heat
       */
      state_heat?: Integer | Integer[];

      /**
       * Value corresponding to HVAC Cool mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_cool
       */
      state_cool?: Integer | Integer[];

      /**
       * Value corresponding to HVAC Auto mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_auto
       */
      state_auto?: Integer | Integer[];

      /**
       * Value corresponding to HVAC Dry mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_dry
       */
      state_dry?: Integer | Integer[];

      /**
       * Value corresponding to HVAC Fan only mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_only
       */
      state_fan_only?: Integer | Integer[];

      /**
       * Value corresponding to HVAC Heat/Cool mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_heat_cool
       */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#fan_mode_register
   */
  fan_mode_register?: {
    /**
     * Address of Fan mode register. (int to call write_register, list of 1 int to call write_registers).
     * https://docs.apexinfosys.in/integrations/modbus/#address-3
     */
     ...
     * https://docs.apexinfosys.in/integrations/modbus/#values-2
     */
    values: {
      /**
       * Value corresponding to Fan On mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_on
       */
      state_fan_on?: Integer;

      /**
       * Value corresponding to Fan Off mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_off
       */
      state_fan_off?: Integer;

      /**
       * Value corresponding to Fan Low mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_low
       */
      state_fan_low?: Integer;

      /**
       * Value corresponding to Fan Medium mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_medium
       */
      state_fan_medium?: Integer;

      /**
       * Value corresponding to Fan High mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_high
       */
      state_fan_high?: Integer;

      /**
       * Value corresponding to Fan Auto mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_auto
       */
      state_fan_auto?: Integer;

      /**
       * Value corresponding to Fan Top mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_top
       */
      state_fan_top?: Integer;

      /**
       * Value corresponding to Fan Middle mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_middle
       */
      state_fan_middle?: Integer;

      /**
       * Value corresponding to Fan Focus mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_focus
       */
      state_fan_focus?: Integer;

      /**
       * Value corresponding to Fan Diffuse mode.
       * https://docs.apexinfosys.in/integrations/modbus/#state_fan_diffuse
       */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#hvac_onoff_coil
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#hvac_onoff_register
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#hvac_on_value
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#hvac_off_value
   */
  hvac_off_value?: Integer;

  /**
   * Configuration of the register for swing mode.
   * https://docs.apexinfosys.in/integrations/modbus/#swing_mode_register
   */
  swing_mode_register?: {
    /**
     ...
     * https://docs.apexinfosys.in/integrations/modbus/#address-4
     */
    address: Integer | Integer[];

    /**
     * Mapping between the register values and swing modes.
     * https://docs.apexinfosys.in/integrations/modbus/#values-3
     */
    values: {
      /**
       * Value corresponding to swing mode on.
       * https://docs.apexinfosys.in/integrations/modbus/#swing_mode_state_on
       */
      swing_mode_state_on?: Integer;

      /**
       * Value corresponding to swing mode off.
       * https://docs.apexinfosys.in/integrations/modbus/#swing_mode_state_off
       */
      swing_mode_state_off?: Integer;

      /**
       * Value corresponding to swing mode horizontal.
       * https://docs.apexinfosys.in/integrations/modbus/#swing_mode_state_horizontal
       */
      swing_mode_state_horizontal?: Integer;

      /**
       * Value corresponding to swing mode vertical.
       * https://docs.apexinfosys.in/integrations/modbus/#swing_mode_state_vertical
       */
      swing_mode_state_vertical?: Integer;

      /**
       * Value corresponding to Swing mode both.
       * https://docs.apexinfosys.in/integrations/modbus/#swing_mode_state_both
       */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#write_registers-1
   */
  write_registers?: boolean;
}
...
interface CoverItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#device_class-1
   */
  device_class?: DeviceClassesCover;

  /**
   * Cover register type.
   * https://docs.apexinfosys.in/integrations/modbus/#input_type-3
   */
  input_type?: "holding" | "input";
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#state_open
   */
  state_open?: Integer;
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#state_closed
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#state_opening
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#state_closing
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#status_register
   */
  status_register?: Integer;

  /**
   * Cover status register type (holding, input), default holding.
   * https://docs.apexinfosys.in/integrations/modbus/#status_register_type
   */
...
interface FanItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#command_on
   */
  command_on?: Integer;

  /**
   * Value to write to turn off the fan.
   * https://docs.apexinfosys.in/integrations/modbus/#command_off
   */
  command_off?: Integer;

  /**
   * Type of write request.
   * https://docs.apexinfosys.in/integrations/modbus/#write_type
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#verify
   */
  verify?: {
    /**
     * Address to read from.
     * https://docs.apexinfosys.in/integrations/modbus/#address-5
     */
    address?: Integer;

    /**
     * Delay between write and verify.
     * https://docs.apexinfosys.in/integrations/modbus/#delay-1
     */
    delay?: Integer;

    /**
     * Type of address.
     * https://docs.apexinfosys.in/integrations/modbus/#input_type-4
     */
    input_type?: "coil" | "discrete" | "holding" | "input";

    /**
     * Value when the fan is on.
     * https://docs.apexinfosys.in/integrations/modbus/#state_on
     */
    state_on?: Integer;

    /**
     * Value when the fan is off.
     * https://docs.apexinfosys.in/integrations/modbus/#state_off-1
     */
    state_off?: Integer;
  };
}
...
interface LightItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#command_on-1
   */
  command_on?: Integer;

  /**
   * Value to write to turn off the light.
   * https://docs.apexinfosys.in/integrations/modbus/#command_off-1
   */
  command_off?: Integer;

  /**
   * Type of write request.
   * https://docs.apexinfosys.in/integrations/modbus/#write_type-1
   */
  write_type?: "holding" | "holdings" | "coil" | "coils";
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#verify-1
   */
  verify?: {
    /**
     * Address to read from.
     * https://docs.apexinfosys.in/integrations/modbus/#address-6
     */
    address?: Integer;

    /**
     * Delay between write and verify.
     * https://docs.apexinfosys.in/integrations/modbus/#delay-2
     */
    delay?: Integer;

    /**
     * Type of address (holding/coil/discrete/input).
     * https://docs.apexinfosys.in/integrations/modbus/#input_type-5
     */
    input_type?: "coil" | "discrete" | "holding" | "input";

    /**
     * Value when the light is on.
     * https://docs.apexinfosys.in/integrations/modbus/#state_on-1
     */
    state_on?: Integer;

    /**
     * Value when the light is off.
     * https://docs.apexinfosys.in/integrations/modbus/#state_off-2
     */
    state_off?: Integer;
  };
}
...
interface SensorItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#count-1
   */
  count?: Integer;

  /**
   * Response representation.
   * https://docs.apexinfosys.in/integrations/modbus/#data_type-1
   */
  data_type?:
    | "custom"
    | "float16"
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#device_class-2
   */
  device_class?: DeviceClassesSensor;

  /**
   * Modbus register type for sensor.
   * https://docs.apexinfosys.in/integrations/modbus/#input_type-6
   */
  input_type?: "holding" | "input";

  /**
   * The minimum allowed value of a sensor. If value < min_value –> min_value. Can be float or integer.
   * https://docs.apexinfosys.in/integrations/modbus/#min_value
   */
  min_value?: number;

  /**
   * The maximum allowed value of a sensor. If value > max_value –> max_value. Can be float or integer.
   * https://docs.apexinfosys.in/integrations/modbus/#max_value
   */
  max_value?: number;

  /**
   * If a Modbus sensor has a defined NaN value, this value can be set as a hex string starting with 0x containing one or more bytes (for example, 0xFFFF or 0x80000000) or provided as an integer directly. If triggered, the sensor becomes unavailable. Please note that the hex to int conversion for nan_value does currently not obey apexoss Modbus encoding using the data_type, structure, or swap arguments.
   * https://docs.apexinfosys.in/integrations/modbus/#nan_value
   */
  nan_value?: string | Integer;

  /**
   * Suppress values close to zero. If -zero_suppress <= value <= +zero_suppress –> 0. Can be float or integer.
   * https://docs.apexinfosys.in/integrations/modbus/#zero_suppress
   */
  zero_suppress?: number;

  /**
   * Final offset (output = scale * value + offset).
   * https://docs.apexinfosys.in/integrations/modbus/#offset-1
   */
  offset?: number;

  /**
   * Number of valid decimals.
   * https://docs.apexinfosys.in/integrations/modbus/#precision-1
   */
  precision?: Integer;

  /**
   * Scale factor (output = scale * value + offset).
   * https://docs.apexinfosys.in/integrations/modbus/#scale-1
   */
  scale?: number;

  /**
   * Identical to virtual_count.
   * https://docs.apexinfosys.in/integrations/modbus/#slave_count-1
   */
  slave_count?: Integer;

  /**
   * Generates x-1 slave sensors, allowing read of multiple registers with a single read message.
   * https://docs.apexinfosys.in/integrations/modbus/#virtual_count-1
   */
  virtual_count?: Integer;

  /**
   * The state_class of the sensor.
   * https://docs.apexinfosys.in/integrations/modbus/#state_class
   */
  state_class?: StateClassesSensor;

  /**
   * If data_type: custom is specified a double-quoted Python struct is expected, to format the string to unpack the value. See Python documentation for details. Example: >i.
   * https://docs.apexinfosys.in/integrations/modbus/#structure-1
   */
  structure?: string;

  /**
   * Swap the order of bytes/words, not valid with custom and datatype: string.
   * https://docs.apexinfosys.in/integrations/modbus/#swap-1
   */
  swap?: "byte" | "word" | "word_byte";

  /**
   * Unit to attach to value.
   * https://docs.apexinfosys.in/integrations/modbus/#unit_of_measurement
   */
...
interface SwitchItem extends BaseEntityItem {
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#command_on-2
   */
  command_on?: Integer;

  /**
   * Value to write to turn off the switch.
   * https://docs.apexinfosys.in/integrations/modbus/#command_off-2
   */
  command_off?: Integer;

  /**
   * Type of write request.
   * https://docs.apexinfosys.in/integrations/modbus/#write_type-2
   */
  write_type?: "holding" | "holdings" | "coil" | "coils";
   ...
   * https://docs.apexinfosys.in/integrations/modbus/#verify-2
   */
  verify?: {
    /**
     * Address to read from.
     * https://docs.apexinfosys.in/integrations/modbus/#address-7
     */
    address?: Integer;

    /**
     * Delay between write and verify.
     * https://docs.apexinfosys.in/integrations/modbus/#delay-3
     */
    delay?: Integer;

    /**
     * Type of address.
     * https://docs.apexinfosys.in/integrations/modbus/#input_type-7
     */
    input_type?: "coil" | "discrete" | "holding" | "input";

    /**
     * Value(s) when switch is on. The value must be an integer or a list of integers.
     * https://docs.apexinfosys.in/integrations/modbus/#state_on-2
     */
    state_on?: Integer | Integer[];

    /**
     * Value(s) when switch is off. The value must be an integer or a list of integers.
     * https://docs.apexinfosys.in/integrations/modbus/#state_off-3
     */
    state_off?: Integer | Integer[];
  };
}
