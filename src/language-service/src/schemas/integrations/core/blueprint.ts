 ...
 * Source:
 * - https://github.com/apexos/core/blob/dev/apexos/components/blueprint/__init__.py
 * - https://github.com/apexos/core/blob/dev/apexos/components/blueprint/models.py
 * - https://github.com/apexos/core/blob/dev/apexos/components/blueprint/schemas.py
 */
import { 
  BinarySensorItem, 
  SensorItem
...
export interface AutomationBlueprint extends AutomationItem {
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#the-blueprint-schema
   */
  blueprint: Blueprint;
}
...
export interface TemplateBlueprint {
   ...
   * https://docs.apexinfosys.in/integrations/template/#binary-sensor
   */
...
interface Blueprint {
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#author
   */
  author?: string;

  /**
   * The description of the blueprint. While optional, this field is highly recommended. The description can include Markdown.
   * https://docs.apexinfosys.in/docs/blueprint/schema/#description
   */
  description?: string;

  /**
   * The domain name this blueprint provides a blueprint for.
   * https://docs.apexinfosys.in/docs/blueprint/schema/#domain
   */
  domain: string;

  /**
   * ApexOS requirements for this Blueprint.
   */
  apexos?: {
    /**
     * The minimal version number of ApexOS Core that is needed for this Blueprint.
     */
    min_version?: string;
  };
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#input
   */
  input?: {
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#name
   */
  name: string;
...
interface BlueprintInputSchema {
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#default
   */
  default?: any;
...
interface BlueprintInputSectionSchema {
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#icon
   */
  icon?: string;
   ...
   * https://docs.apexinfosys.in/docs/blueprint/schema/#collapsed
   */
  collapsed?: boolean;
