/**
 * Cloud integration
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/cloud/__init__.py
 */
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/config/amazon_alexa/
   */
  alexa?: {
    /**
  ...
  /**
   * The Google Assistant integration allows users to control the entities via the ApexOS Smart Home skill for Google Assistant.
   * https://docs.apexinfosys.in/config/google_assistant/
   */
  google_actions?: {
    /**
