 ...
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/input_boolean/__init__.py
 */
...
interface Item {
   ...
   * https://docs.apexinfosys.in/integrations/input_boolean#initial
   */
  initial?: boolean;

  /**
   * Name of the input boolean.
   * https://docs.apexinfosys.in/integrations/input_boolean#name
   */
  name?: string;
}
