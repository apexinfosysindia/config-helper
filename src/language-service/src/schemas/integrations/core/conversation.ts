 ...
 * Source: https://github.com/apexos/core/blob/dev/apexos/components/conversation/__init__.py
 */
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/integrations/conversation#intents
   */
...
export interface CustomSentence {
   ...
   * https://docs.apexinfosys.in/voice_control/custom_sentences_yaml/
   */
  language: string;
   ...
   * https://docs.apexinfosys.in/voice_control/custom_sentences_yaml/#customizing-responses
   */
  responses?: {
    /**
