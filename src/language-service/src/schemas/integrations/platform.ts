...
export interface PlatformSchema {
   ...
   * https://docs.apexinfosys.in/docs/configuration/platform_options/#entity-namespace
   */
  entity_namespace?: string;

  /**
   * Allow to change the polling interval if the platform uses a polling mechanism.
   * https://docs.apexinfosys.in/docs/configuration/platform_options/#scan-interval
   */
