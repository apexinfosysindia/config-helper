...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/light/const.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/binary_sensor/__init__.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/cover/__init__.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/media_player/__init__.py
 */
export type DeviceClassesMediaPlayer = "tv" | "speaker" | "receiver";

/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/sensor/const.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/const.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/switch/__init__.py
 */
...
interface SensorEntityOffset {
   ...
   * https://docs.apexinfosys.in/docs/automation/trigger/#sensors-of-datetime-device-class-with-offsets
   */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/alarm_control_panel/const.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/camera/__init__.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/climate/const.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/fan/__init__.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/lock/__init__.py
 */
export type SupportedFeatureLock = "lock.LockEntityFeature.OPEN";

/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/update/const.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/vacuum/__init__.py
 */
...
/**
 * From: https://github.com/apexos/core/blob/dev/apexos/components/weather/const.py
 */
