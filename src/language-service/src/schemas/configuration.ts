...
export interface ConfigurationRoot
  ...
  CustomIntegrations {
  /**
   * ApexOS Core configuration
   * https://docs.apexinfosys.in/docs/configuration/basic
   */
  apexos?: integrations.Core.ApexOS.Schema | IncludeList;
}

/**
 * This interface contains all integrations that are marked as "internal" to
 * ApexOS. Core things like light, switch, sensor, automations.
 * These integrations generally do not connect with a device or service.
 */
export interface InternalIntegrations {
  /**
   * ApexOS can give you an interface which is similar to a classic alarm system.
   * https://docs.apexinfosys.in/integrations/alarm_control_panel
   */
  alarm_control_panel?:
   ...
   * https://docs.apexinfosys.in/integrations/alert
   */
   ...
   * https://docs.apexinfosys.in/docs/automation/
   */
   ...
   * https://docs.apexinfosys.in/integrations/binary_sensor
   */
   ...
   * https://docs.apexinfosys.in/integrations/blueprint
   */
  blueprint?: integrations.Core.Blueprint.Schema;

  /**
   * The camera integration allows you to use IP cameras with ApexOS.
   * https://docs.apexinfosys.in/integrations/camera
   */
   ...
   * https://docs.apexinfosys.in/integrations/climate
   */
  climate?: integrations.Core.Climate.Schema | IncludeList;

  /**
   * The conversation integration allows you to converse with ApexOS.
   * https://docs.apexinfosys.in/integrations/conversation
   */
   ...
   * https://docs.apexinfosys.in/integrations/counter
   */
  counter?: integrations.Core.Counter.Schema | IncludeNamed | null;

  /**
   * ApexOS can give you an interface to control covers such as rollershutters, blinds, and garage doors.
   * https://docs.apexinfosys.in/integrations/cover
   */
  cover?: integrations.Core.Cover.Schema | IncludeList;

  /**
   * This integration is a meta-component and configures a default set of integrations for ApexOS to load.
   * https://docs.apexinfosys.in/integrations/default_config
   */
  default_config?: null;

  /**
   * The device tracker allows you to track devices in ApexOS. This can happen by querying your wireless router or by having applications push location info.
   * https://docs.apexinfosys.in/integrations/device_tracker
   */
   ...
   * https://docs.apexinfosys.in/integrations/fan
   */
  fan?: integrations.Core.Fan.Schema | IncludeList;

  /**
   * Groups allows you to combine multiple entities into a single group entity.
   * https://docs.apexinfosys.in/integrations/group
   */
  group?: integrations.Core.Group.Schema | IncludeNamed | null;

  /**
   * The http integration serves all files and data required for the ApexOS frontend. You only need to add this to your configuration file if you want to change any of the default settings.
   * https://docs.apexinfosys.in/integrations/http
   */
   ...
   * https://docs.apexinfosys.in/integrations/input_boolean
   */
   ...
   * https://docs.apexinfosys.in/integrations/input_button
   */
   ...
   * https://docs.apexinfosys.in/integrations/input_datetime
   */
   ...
   * https://docs.apexinfosys.in/integrations/input_number
   */
   ...
   * https://docs.apexinfosys.in/integrations/input_select
   */
   ...
   * https://docs.apexinfosys.in/integrations/input_text
   */
   ...
   * https://docs.apexinfosys.in/integrations/light
   */
  light?: integrations.Core.Light.Schema | IncludeList;

  /**
   * Keeps track which locks are in your environment, their state and allows you to control them.
   * https://docs.apexinfosys.in/integrations/lock
   */
  lock?: integrations.Core.Lock.Schema | IncludeList;

  /**
   * Lovelace is the ApexOS dashboard. It’s a fast, customizable and powerful way for users to manage their homes, working on mobile and desktop.
   * https://docs.apexinfosys.in/lovelace
   */
   ...
   * https://docs.apexinfosys.in/integrations/modbus/
   */
   ...
   * https://docs.apexinfosys.in/integrations/number
   */
  number?: integrations.Core.Number.Schema | IncludeList;

  /**
   * The panel_iframe support allows you to add additional panels to your ApexOS frontend. The panels are listed in the sidebar and can contain external resources like the web frontend of your router, your monitoring system, or your media server.
   * https://docs.apexinfosys.in/integrations/panel_iframe
   */
  panel_iframe?: integrations.Core.PanelIframe.Schema | IncludeNamed;

  /**
   * The script integration allows users to specify a sequence of actions to be executed by ApexOS. These are run when you turn the script on. The script integration will create an entity for each script and allow them to be controlled via services.
   * https://docs.apexinfosys.in/integrations/script
   */
   ...
   * https://docs.apexinfosys.in/integrations/select
   */
  select?: integrations.Core.Select.Schema | IncludeList;

  /**
   * Sensors are gathering information about states and conditions.
   * https://docs.apexinfosys.in/integrations/sensor
   */
  sensor?: integrations.Core.Sensor.Schema | IncludeList;

  /**
   * Keeps track which switches are in your environment, their state and allows you to control them.
   * https://docs.apexinfosys.in/integrations/switch
   */
   ...
   * https://docs.apexinfosys.in/integrations/timer/
   */
  timer?: integrations.Core.Timer.Schema | IncludeNamed | null;

  /**
   * The vacuum integration enables the ability to control home cleaning robots within ApexOS.
   * https://docs.apexinfosys.in/integrations/vacuum
   */
   ...
   * https://docs.apexinfosys.in/integrations/weather
   */
 ...
 * but are shipped with ApexOS by default.
 */
export interface CoreIntegrations {
  /**
   * The ApexOS Cloud allows you to quickly integrate your local ApexOS with various cloud services like Amazon Alexa and Google Assistant.
   * https://docs.apexinfosys.in/config/
   */
   ...
   * https://docs.apexinfosys.in/integrations/compensation/
   */
  compensation?: integrations.Core.Compensation.Schema | IncludeNamed;

  /**
   * The KNX integration for ApexOS allows you to connect to KNX/IP devices.
   * https://docs.apexinfosys.in/integrations/knx
   */
  knx?: integrations.Core.KNX.Schema | IncludeNamed;

  /**
   * MQTT (aka MQ Telemetry Transport) is a machine-to-machine or “Internet of Things” connectivity protocol on top of TCP/IP. It allows extremely lightweight publish/subscribe messaging transport.
   * https://docs.apexinfosys.in/integrations/mqtt/
   */
  mqtt?: integrations.Core.MQTT.Schema | IncludeNamed;

  /**
   * The mqtt_eventstream integration connects two ApexOS instances via MQTT.
   * https://docs.apexinfosys.in/integrations/mqtt_eventstream
   */
  mqtt_eventstream?: integrations.Core.MQTTEventstream.Schema | null;

  /**
   * The mqtt_statestream integration publishes state changes in ApexOS to individual MQTT topics.
   * https://docs.apexinfosys.in/integrations/mqtt_statestream
   */
