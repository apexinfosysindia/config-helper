/**
 * Lovelace Elements.
 * Source: https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/elements
 */
...
export interface ConditionalElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#conditional-element
   */
  type: "conditional";

  /**
   * List of entity IDs and matching states.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#conditions
   */
...
export interface IconElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#icon-element
   */
  type: "icon";

  /**
   * Action taken on card double tap.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#double_tap_action
   */
  double_tap_action?: Action;

  /**
   * Entity to use for more-info/toggle.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#entity
   */
  entity?: Entity;

  /**
   * Action taken on card tap and hold..
   * https://docs.apexinfosys.in/lovelace/picture-elements/#hold_action
   */
  hold_action?: Action;

  /**
   * Icon to display (e.g., mdi:home).
   * https://docs.apexinfosys.in/lovelace/picture-elements/#icon
   */
  icon: string;

  /**
   * Position and style the element using CSS.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#style
   */
  style: Style;

  /**
   * Action taken on card tap.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#tap_action
   */
  tap_action?: Action;
}
...
export interface ImageElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#image-element
   */
  type: "image";

  /**
   * Height-width-ratio. Defaults to 50%.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#aspect_ratio
   */
  aspect_ratio?: string;

  /**
   * A camera entity.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#camera_image
   */
  ...
  /**
   * Default CSS filter.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#filter
   */
  filter?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#how-to-use-state_filter
   */
  state_filter?: { [key: string]: string };

  /**
   * Specify a different image to display based on the state of the entity.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#how-to-use-state_image
   */
...
export interface ServiceButtonElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#service-call-button
   */
  type: "service-button";

  /**
   * The ApexOS service to call.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#service
   */
  service: string;

  /**
   * The service data to pass into the service call.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#service_data
   */
  service_data?: Data;
...
export interface StateBadgeElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#state-badge
   */
  type: "state-badge";
...
export interface StateIconElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#state-icon
   */
  type: "state-icon";
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#state_color
   */
  state_color?: boolean;
...
export interface StateLabelElement {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#state-label
   */
  type: "state-label";
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#attribute
   */
  attribute?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/picture-elements/#prefix
   */
  prefix?: string;

  /**
   * Text after entity state.
   * https://docs.apexinfosys.in/lovelace/picture-elements/#suffix
   */
  suffix?: string;
