 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/energy/hui-energy-distribution-card.ts
 */
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/energy/#energy-distribution
   */
