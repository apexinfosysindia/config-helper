 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-media-control-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/media-control/#entity
   */
  entity: MediaPlayerEntity;

  /**
   * Overwrite friendly name.
   * https://docs.apexinfosys.in/lovelace/media-control/#name
   */
  name?: string;
