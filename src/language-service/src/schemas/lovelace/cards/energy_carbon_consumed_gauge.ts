 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/energy/hui-energy-solar-consumed-gauge-card.ts
 */
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/energy/#carbon-consumed-gauge
   */
