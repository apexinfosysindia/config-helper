 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-vertical-stack-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/vertical-stack/
   */
  type: "vertical-stack";

  /**
   * List of cards.
   * https://docs.apexinfosys.in/lovelace/vertical-stack/#cards
   */
  cards: Card[];

  /**
   * Title of Stack.
   * https://docs.apexinfosys.in/lovelace/vertical-stack/#title
   */
  title?: string;
