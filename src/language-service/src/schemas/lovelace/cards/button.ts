 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-button-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/button/
   */
  type: "button";

  /**
   * The action taken on card double-tap.
   * https://docs.apexinfosys.in/lovelace/button/#double_tap_action
   */
  double_tap_action?: Action;

  /**
   * The entity ID the card interacts with, for example, light.living_room.
   * https://docs.apexinfosys.in/lovelace/button/#entity
   */
  entity?: Entity;

  /**
   * The action taken on card tap and hold.
   * https://docs.apexinfosys.in/lovelace/button/#hold_action
   */
  hold_action?: Action;

  /**
   * The height of the icon. Any CSS value may be used.
   * https://docs.apexinfosys.in/lovelace/button/#icon_height
   */
  icon_height?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/button/#icon
   */
  icon?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/button/#name
   */
  name?: string;

  /**
   * If false, the icon is not shown on the card.
   * https://docs.apexinfosys.in/lovelace/button/#show_icon
   */
  show_icon?: boolean;

  /**
   * If false, the button name is not shown on the card.
   * https://docs.apexinfosys.in/lovelace/button/#show_name
   */
  show_name?: boolean;

  /**
   * If false, the button state is not shown on the card.
   * https://docs.apexinfosys.in/lovelace/button/#show_state
   */
  show_state?: boolean;

  /**
   * If false, the icon does not change color when the entity is active.
   * https://docs.apexinfosys.in/lovelace/button/#state_color
   */
  state_color?: boolean;

  /**
   * The action taken on card tap.
   * https://docs.apexinfosys.in/lovelace/button/#tap_action
   */
  tap_action?: Action;

  /**
   * The card theme, which may be set to any theme from the themes.yaml file.
   * https://docs.apexinfosys.in/lovelace/button/#theme
   */
  theme?: string;
