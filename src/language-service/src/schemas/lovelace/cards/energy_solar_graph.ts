 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/energy/hui-energy-solar-graph-card.ts
 */
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/energy/#solar-production-graph
   */
