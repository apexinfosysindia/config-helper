 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-markdown-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/media-control/
   */
  type: "markdown";

  /**
   * Content to render as Markdown. May contain templates.
   * https://docs.apexinfosys.in/lovelace/markdown/#content
   */
  content: string;

  /**
   * The card title.
   * https://docs.apexinfosys.in/lovelace/markdown/#title
   */
  title?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/markdown/#card_size
   */
   ...
   * https://docs.apexinfosys.in/lovelace/markdown/#entity_id
   */
