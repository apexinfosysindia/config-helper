 ...
 * Tile Card
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-tile-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/dashboards/tile/
   */
  type: "tile";
   ...
   * https://docs.apexinfosys.in/dashboards/tile/#color
   */
  color?: string;

  /**
   * Entity to show in the tile card
   * https://docs.apexinfosys.in/dashboards/tile/#entity
   */
  entity: EntityString;
...
interface CoverOpenCloseFeature {
   ...
   * https://docs.apexinfosys.in/dashboards/tile/#cover-openclose
   */
...
interface CoverTiltFeature {
  /**
   * Widget that display buttons to open, close or stop a cover.
   * https://docs.apexinfosys.in/dashboards/tile/#cover-tilt
   */
  type: "cover-tilt";
}
...
interface LightBrightnessFeature {
   ...
   * https://docs.apexinfosys.in/dashboards/tile/#light-brightness
   */
...
interface VacuumCommandsFeature {
   ...
   * https://docs.apexinfosys.in/dashboards/tile/#vacuum-commands
   */
  type: "vacuum-commands";

  /**
   * List of commands to show on the card.
   * https://docs.apexinfosys.in/dashboards/tile/#commands
   */
