 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-history-graph-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/history-graph/
   */
  type: "history-graph";

  /**
   * A list of entity IDs or entity objects.
   * https://docs.apexinfosys.in/lovelace/history-graph/#entities
   */
  entities?: Entity[];

  /**
   * Hours to show. Minimum is 1 hour, maximum of 80 hours.
   * https://docs.apexinfosys.in/lovelace/history-graph/#hours_to_show
   *
   * @min 1
   * @max 80
   */
   ...
   * https://docs.apexinfosys.in/lovelace/history-graph/#refresh_interval
   */
  refresh_interval?: PositiveInteger;

  /**
   * The card title.
   * https://docs.apexinfosys.in/lovelace/history-graph/#title
   */
  title?: string;
