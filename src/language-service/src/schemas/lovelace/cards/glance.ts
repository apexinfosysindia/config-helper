 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-glance-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/glance/
   */
  type: "glance";

  /**
   * Number of columns to show. If not specified the number will be set automatically.
   * https://docs.apexinfosys.in/lovelace/glance/#columns
   */
  columns?: PositiveInteger;

  /**
   * A list of entity IDs or entity objects.
   * https://docs.apexinfosys.in/lovelace/glance/#entities
   */
  entities?: Entity[];

  /**
   * Show entity icon.
   * https://docs.apexinfosys.in/lovelace/glance/#show_icon
   */
  show_icon?: boolean;

  /**
   * Show entity name.
   * https://docs.apexinfosys.in/lovelace/glance/#show_name
   */
  show_name?: boolean;

  /**
   * Show entity state-text.
   * https://docs.apexinfosys.in/lovelace/glance/#show_state
   */
  show_state?: boolean;

  /**
   * Set to true to have icons colored when entity is active.
   * https://docs.apexinfosys.in/lovelace/glance/#state_color
   */
  state_color?: boolean;

  /**
   * Set to any theme within themes.yaml.
   * https://docs.apexinfosys.in/lovelace/glance/#theme
   */
  theme?: string;
...
interface GlanceEntityConfig extends EntityConfig {
   ...
   * https://docs.apexinfosys.in/lovelace/glance/#double_tap_action
   */
  double_tap_action?: Action;

  /**
   * Action taken on card tap and hold.
   * https://docs.apexinfosys.in/lovelace/glance/#hold_action
   */
  hold_action?: Action;

  /**
   * Overwrites entity picture.
   * https://docs.apexinfosys.in/lovelace/glance/#image
   */
  image?: string;

  /**
   * Overwrites the state display with the relative time since last changed.
   * https://docs.apexinfosys.in/lovelace/glance/#show_last_changed
   */
   ...
   * https://docs.apexinfosys.in/lovelace/glance/#tap_action
   */
  tap_action?: Action;
}
