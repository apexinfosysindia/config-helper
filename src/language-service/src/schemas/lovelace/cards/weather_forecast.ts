 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-weather-forecast-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/weather-forecast/
   */
  type: "weather-forecast";

  /**
   * The entity_id of the weather platform to use.
   * https://docs.apexinfosys.in/lovelace/weather-forecast/#entity
   */
  entity: WeatherEntity;

  /**
   * Overwrites the friendly name.
   * https://docs.apexinfosys.in/lovelace/weather-forecast/#name
   */
  name?: string;

  /**
   * Show next hours/days forecast.
   * https://docs.apexinfosys.in/lovelace/weather-forecast/#show_forecast
   */
  show_forecast?: boolean;

  /**
   * Which attribute to display under the temperature.
   * https://docs.apexinfosys.in/lovelace/weather-forecast/#secondary_info_attribute
   */
  secondary_info_attribute?: string;

  /**
   * Set to any theme within themes.yaml.
   * https://docs.apexinfosys.in/lovelace/weather-forecast/#theme
   */
  theme?: string;
