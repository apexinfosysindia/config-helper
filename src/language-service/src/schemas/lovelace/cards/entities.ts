 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-entities-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/
   */
  type: "entities";
   ...
   * https://docs.apexinfosys.in/lovelace/header-footer/
   */
  footer?: HeaderFooter;
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#show_header_toggle
   */
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#theme
   */
  theme?: string;

  /**
   * The card title.
   * https://docs.apexinfosys.in/lovelace/entities/#title
   */
  title?: string;
