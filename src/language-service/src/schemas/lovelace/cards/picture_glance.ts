 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-picture-glance-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-glance/
   */
  type: "picture-glance";

  /**
   * Forces the height of the image to be a ratio of the width. You may enter a value such as: 16x9, 16:9, 1.78.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#aspect_ratio
   */
  aspect_ratio?: string;

  /**
   * Camera entity as Background image.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#camera_image
   */
  camera_image?: CameraEntity;

  /**
   * “live” will show the live view if stream is enabled.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#camera_view
   */
  camera_view?: "auto" | "live";

  /**
   * Action taken on card double tap.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#double_tap_action
   */
  double_tap_action?: Action;

  /**
   * List of entities or entity objects.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#entities
   */
  entities: Entity[];

  /**
   * Entity to use for state_image and state_filter.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#entity
   */
  entity?: EntityString;

  /**
   * Action taken on card tap and hold.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#hold_action
   */
  hold_action?: Action;

  /**
   * Background image URL.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#image
   */
  image?: string;

  /**
   * Show entity state-text.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#show_state
   */
  show_state?: boolean;

  /**
   * State-based CSS filters.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#how-to-use-state_filter
   */
  state_filter?: { [key: string]: string };

  /**
   * Background image based on entity state.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#state_image
   */
  state_image?: { [key: string]: string };

  /**
   * Action taken on card tap.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#tap_action
   */
  tap_action?: Action;

  /**
   * Set to any theme within themes.yaml.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#theme
   */
  theme?: string;

  /**
   * The card title.
   * https://docs.apexinfosys.in/lovelace/picture-glance/#title
   */
  title?: string;
...
interface PictureGlanceEntityConfig extends EntityConfig {
   ...
   * https://docs.apexinfosys.in/lovelace/picture-glance/#attribute
   */
  attribute?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/picture-glance/#prefix
   */
  prefix?: string;
   ...
   * https://docs.apexinfosys.in/lovelace/picture-glance/#suffix
   */
  suffix?: string;
