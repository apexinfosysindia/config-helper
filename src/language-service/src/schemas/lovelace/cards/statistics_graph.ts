 ...
 * Sources:
 *  - https://github.com/apexos/frontend/blob/dev/src/panels/lovelace/cards/hui-statistics-graph-card.ts
...
export interface Schema {
   ...
   * https://docs.apexinfosys.in/lovelace/statistics-graph/
   */
  type: "statistics-graph";

  /**
   * A list of entity IDs or entity objects.
   * https://docs.apexinfosys.in/lovelace/statistics-graph/#entities
   */
  entities: Entity[];

  /**
   * If the chart should be rendered as a bar or a line chart.
   * https://docs.apexinfosys.in/lovelace/statistics-graph/#chart_type
   */
  chart_type?: "bar" | "line";

  /**
   * Days to show in graph. Minimum is 1 day.
   * https://docs.apexinfosys.in/lovelace/statistics-graph/#days_to_show
   *
   * @min 1
   */
   ...
   * https://docs.apexinfosys.in/lovelace/statistics-graph/#period
   */
  period?: "5minute" | "hour" | "day" | "month";

  /**
   * The stat types to render. min, max, mean, sum.
   * https://docs.apexinfosys.in/lovelace/statistics-graph/#stat_types
   */
  stat_types?: StatType | StatType[];

  /**
   * The card title.
   * https://docs.apexinfosys.in/lovelace/statistics-graph/#title
   */
  title?: string;
