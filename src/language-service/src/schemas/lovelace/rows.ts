...
export interface AttributeRow extends EntityConfig {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#attribute
   */
  type: "attribute";
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#prefix
   */
  prefix?: string;

  /**
   * Text after entity state.
   * https://docs.apexinfosys.in/lovelace/entities/#suffix
   */
  suffix?: string;
}
...
export interface ButtonRow extends EntityConfig {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#button
   */
  type: "button";

  /**
   * Button label.
   * https://docs.apexinfosys.in/lovelace/entities/#action_name
   */
  action_name?: string;

  /**
   * Action taken on card double tap.
   * https://docs.apexinfosys.in/lovelace/entities/#double_tap_action
   */
  double_tap_action?: Action;

  /**
   * Action taken on card tap and hold.
   * https://docs.apexinfosys.in/lovelace/entities/#hold_action
   */
  hold_action?: Action;

  /**
   * Action taken on card tap.
   * https://docs.apexinfosys.in/lovelace/entities/#tap_action
   */
  tap_action?: Action;
}
...
export interface ButtonsRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#buttons
   */
  type: "buttons";

  /**
   * A list of entities to show. Each entry is either an entity ID or a map.
   * https://docs.apexinfosys.in/lovelace/entities/#entities
   */
...
export interface CallServiceRow extends EntityConfig {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#data
   */
  service_data?: Data;
...
export interface CastRow {
  /**
   * Special row to start ApexOS Cast.
   * https://docs.apexinfosys.in/lovelace/entities/#cast
   */
  type: "cast";

  /**
   * Path to the dashboard of the view that needs to be shown.
   * https://docs.apexinfosys.in/lovelace/entities/#dashboard
   */
  dashboard?: string;

  /**
   * Hide this row if casting is not available in the browser.
   * https://docs.apexinfosys.in/lovelace/entities/#hide_if_unavailable
   */
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#view
   */
  view: string | number;
}
...
export interface ConditionalRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#conditional
   */
  type: "conditional";

  /**
   * List of entity IDs and matching states.
   * https://docs.apexinfosys.in/lovelace/entities/#conditions
   */
  conditions: Condition[];

  /**
   * Row to display if all conditions match.
   * https://docs.apexinfosys.in/lovelace/entities/#row
   */
  row: Row;
}
...
export interface DividerRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#divider
   */
  type: "divider";

  /**
   * Style the element using CSS.
   * https://docs.apexinfosys.in/lovelace/entities/#style
   */
...
interface EntityRow extends EntityConfig {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#format
   */
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#secondary_info
   */
  secondary_info?:
    | "entity-id"
    | "last-changed"
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#state_color
   */
  state_color?: boolean;
...
interface ButtonEntityRow extends EntityRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#show_icon
   */
  show_icon?: boolean;

  /**
   * If false, the button name is not shown.
   * https://docs.apexinfosys.in/lovelace/entities/#show_name
   */
  show_name?: boolean;
}
...
export interface SectionRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#section
   */
  type: "section";

  /**
   * Section label.
   * https://docs.apexinfosys.in/lovelace/entities/#label
   */
  label?: string;
}
...
export interface TextRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#text
   */
  type: "text";
...
export interface WeblinkRow {
   ...
   * https://docs.apexinfosys.in/lovelace/entities/#weblink
   */
  type: "weblink";
  ...
  /**
   * Website URL (or internal URL e.g., /supervisor/dashboard or /panel_custom_name)
   * https://docs.apexinfosys.in/lovelace/entities/#url
   */
  url: string;
}
