...
export class ApexOSLanguageService {
  ...
  private validateEntityIds = async (
    ...
    try {
      ...
      console.log(`Entity validation: Found ${entityIds.length} entities from ApexOS`);
      ...
      for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
        ...
        for (const propertyName of EntityIdCompletionContribution.propertyMatches) {
          ...
          while ((match = propertyRegex.exec(line)) !== null) {
            ...
            // Check if entity exists in ApexOS
            if (!entityIds.includes(cleanEntityValue)) {
              ...
              const diagnostic: Diagnostic = {
                ...
                message: `Entity '${cleanEntityValue}' does not exist in your ApexOS instance`,
                source: "apexos",
                code: "unknown-entity",
              };
            ...
            if (entityMatch) {
              ...
              if (!entityIds.includes(entityValue)) {
                ...
                const diagnostic: Diagnostic = {
                  ...
                  message: `Entity '${entityValue}' does not exist in your ApexOS instance`,
                  source: "apexos",
                  code: "unknown-entity",
                };
  ...
  private validateAreaIds = async (
    ...
    try {
      ...
      console.log(`Area validation: Found ${areaIds.length} areas from ApexOS`);
      ...
      for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
        ...
        for (const propertyName of AreaCompletionContribution.propertyMatches) {
          ...
          while ((match = propertyRegex.exec(line)) !== null) {
            ...
            // Check if area exists in ApexOS
            if (!areaIds.includes(cleanAreaValue)) {
              ...
              const diagnostic: Diagnostic = {
                ...
                message: `Area '${cleanAreaValue}' does not exist in your ApexOS instance`,
                source: "apexos",
                code: "unknown-area",
              };
            ...
            if (areaMatch) {
              ...
              if (!areaIds.includes(areaValue)) {
                ...
                const diagnostic: Diagnostic = {
                  ...
                  message: `Area '${areaValue}' does not exist in your ApexOS instance`,
                  source: "apexos",
                  code: "unknown-area",
                };
  ...
  private validateDeviceIds = async (
    ...
    try {
      ...
      console.log(`Device validation: Found ${deviceIds.length} devices from ApexOS`);
      ...
      for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
        ...
        for (const propertyName of DeviceCompletionContribution.propertyMatches) {
          ...
          while ((match = propertyRegex.exec(line)) !== null) {
            ...
            // Check if device exists in ApexOS
            if (!deviceIds.includes(cleanDeviceValue)) {
              ...
              const diagnostic: Diagnostic = {
                ...
                message: `Device '${cleanDeviceValue}' does not exist in your ApexOS instance`,
                source: "apexos",
                code: "unknown-device",
              };
            ...
            if (deviceMatch) {
              ...
              if (!deviceIds.includes(deviceValue)) {
                ...
                const diagnostic: Diagnostic = {
                  ...
                  message: `Device '${deviceValue}' does not exist in your ApexOS instance`,
                  source: "apexos",
                  code: "unknown-device",
                };
  ...
  private validateFloorIds = async (
    ...
    try {
      ...
      console.log(`Floor validation: Found ${floorIds.length} floors from ApexOS`);
      ...
      for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
        ...
        for (const propertyName of FloorCompletionContribution.propertyMatches) {
          ...
          while ((match = propertyRegex.exec(line)) !== null) {
            ...
            // Check if floor exists in ApexOS
            if (!floorIds.includes(cleanFloorValue)) {
              ...
              const diagnostic: Diagnostic = {
                ...
                message: `Floor '${cleanFloorValue}' does not exist in your ApexOS instance`,
                source: "apexos",
                code: "unknown-floor",
              };
            ...
            if (floorMatch) {
              ...
              if (!floorIds.includes(floorValue)) {
                ...
                const diagnostic: Diagnostic = {
                  ...
                  message: `Floor '${floorValue}' does not exist in your ApexOS instance`,
                  source: "apexos",
                  code: "unknown-floor",
                };
  ...
  private validateLabelIds = async (
    ...
    try {
      ...
      console.log(`Label validation: Found ${labelIds.length} labels from ApexOS`);
      ...
      for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
        ...
        for (const propertyName of LabelCompletionContribution.propertyMatches) {
          ...
          while ((match = propertyRegex.exec(line)) !== null) {
            ...
            // Check if label exists in ApexOS
            if (!labelIds.includes(cleanLabelValue)) {
              ...
              const diagnostic: Diagnostic = {
                ...
                message: `Label '${cleanLabelValue}' does not exist in your ApexOS instance`,
                source: "apexos",
                code: "unknown-label",
              };
            ...
            if (labelMatch) {
              ...
              if (!labelIds.includes(labelValue)) {
                ...
                const diagnostic: Diagnostic = {
                  ...
                  message: `Label '${labelValue}' does not exist in your ApexOS instance`,
                  source: "apexos",
                  code: "unknown-label",
                };
  ...
  private validateActionIds = async (
    ...
    try {
      ...
      console.log(`Action validation: Found ${actionIds.size} actions from ApexOS`);
          ...
          while ((match = propertyRegex.exec(line)) !== null) {
            ...
            if (!actionIds.has(cleanActionValue)) {
              ...
              const diagnostic: Diagnostic = {
                ...
                message: `Action '${cleanActionValue}' does not exist in your ApexOS instance`,
                source: "apexos",
                code: "unknown-action",
              };
            ...
            if (actionMatch) {
              ...
              if (!actionIds.has(actionValue)) {
                ...
                const diagnostic: Diagnostic = {
                  ...
                  message: `Action '${actionValue}' does not exist in your ApexOS instance`,
                  source: "apexos",
                  code: "unknown-action",
                };
  ...
  private async renderTemplate(template: string): Promise<string | null> {
    try {
      ...
      // Check if ApexOS is properly configured
      if (!this.configurationService.isConfigured) {
        // Don't cache connection errors - they should be checked each time
        return "⚠️ ApexOS connection not configured. Please set up your ApexOS URL and token.";
      }
      ...
      // Check for various error formats that ApexOS can return
      ...
      if (error && typeof error === "object" && "response" in error) {
        ...
        if (axiosError.response?.data) {
          // Handle ApexOS API errors that came through as exceptions
      ...
      if (error instanceof Error) {
        if (error.message.includes("Invalid URL")) {
          ...
          return "⚠️ Unable to connect to ApexOS. Please check your connection settings.";
        } else if (error.message.includes("401") || error.message.includes("Unauthorized")) {
          return "⚠️ Authentication failed. Please check your ApexOS token.";
        } else if (error.message.includes("timeout")) {
          return "⚠️ Request timed out. ApexOS may be slow to respond.";
        }
  ...
  private formatTemplateError(result: any): string {
    ...
    // Handle different error formats from ApexOS
    if (result.error) {
  ...
  private formatTemplateResult(result: any, depth = 0): string {
    ...
    if (typeof result === "string") {
      ...
      // Handle Python-style lists that ApexOS might return
