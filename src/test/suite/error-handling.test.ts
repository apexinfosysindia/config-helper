...
`;
    ...
    // Parse the file
    const yamlFile = new ApexOSYamlFile(fileAccessor, testFilePath, "configuration.yaml");
  ...
  test("Handles file not found gracefully", async () => {
    ...
    const yamlFile = new ApexOSYamlFile(fileAccessor, nonExistentFilePath, "configuration.yaml");
